      ...
      <div className='flex justify-between items-center mt-8 lg:mt-16 flex-col lg:flex-row'>
        ...
        >
          <form className='w-full space-y-3 lg:space-y-5'>
            ...
            <textarea className='resize-none border-2 px-5 py-3 h-32 border-black placeholder:text-[#71717A] rounded text-sm w-full' placeholder='Your message*'></textarea>
        ...
        >
          <div className='font-extrabold text-2xl lg:text-5xl mt-5 lg:mt-0 space-y-1 lg:space-y-3'>
            <h2>Let's <span className='text-white' style={{ WebkitTextStroke: '1px black' }}>connect</span></h2>
            <h2>and build something impactful</h2>
          </div>

          <p className='text-[#71717A] text-sm/6 lg:text-base mt-3 lg:mt-6'>
            I am always open to learning opportunities, collaboration, and meaningful discussions 
            around Cybersecurity, AI/ML, and technology. Feel free to reach out.
          </p>
